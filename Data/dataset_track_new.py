    ...
    def __getitem__(self, index: int):
        if self.cfg.bbox:
            ...
            with h5py.File(path, "r") as f:
                ...
                feat = np.ascontiguousarray(f['feat'][:].transpose(2, 0, 1))
                ...
                if self.bbox:
                    ...
                    mask = self.transform_target(mask.transpose((1, 2, 0)))
            ...
            for off in offsets:
                ...
                if cnt == 0:
                    # Sample augmentation once and reuse it across the temporal clip.

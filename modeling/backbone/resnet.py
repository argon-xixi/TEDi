...
class ResNet(nn.Module):
    ...
    def forward(self, input_x): #输入input_x: batch_size,3,256,256
        out = {}
        ...
        out['res2'] = feature2 #16,256,128,128

        feature3 = self.layer2(feature2)
        out['res3'] = feature3 #16,512,64,64

        feature4 = self.layer3(feature3)
        out['res4'] = feature4 #16,1024,32,32

        feature5 = self.layer4(feature4)
        out['res5'] = feature5 #16,2048,16,16

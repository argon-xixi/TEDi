...
from .transformer_decoder.mask2former_transformer_decoder_sam_new import MultiScaleMaskedTransformerDecoder_sam_new #没有sam
import einops
...
class MaskFormerHead(nn.Module):
    ...
    def predictor_init(self, cfg):
        ...
        predictor = MultiScaleMaskedTransformerDecoder_sam_new(in_channels, 
                                                        num_classes, 
                                                        mask_classification,
                                                        hidden_dim,
                                                        num_queries,
...
class MaskFormerModel_sam_new(nn.Module):
